...
public class classMain {
	...
	public static void main(String[] args) {
			...
			while (f) {
				...
				case 2: {
					...
					while (itr.hasNext()) {
						...
						//check for repeated item if present ask the user to edit the quantity , doesnt add it back
						if (id == o.getItem_id()) {
		...
		System.out.println("Wanna Give FeedBack! PRess 1 for it else press anything for bill" ); 
		...
		System.out.println(b.getCust().get_Customer_Id() + b.getCust().get_Customer_Feedback());
